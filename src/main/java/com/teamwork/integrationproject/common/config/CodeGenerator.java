...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://47.240.68.6:3306/dbmybatis?useUnicode=true&characterEncoding=UTF-8&useSSL=false&serverTimezone=GMT%2B8");
        ...
        dsc.setTypeConvert(new MySqlTypeConvert() {
            ...
            public IColumnType processTypeConvert(GlobalConfig globalConfig, String fieldType) {
                // 将数据库中bigint类型转成实体String类型
                if (fieldType.toLowerCase().contains("bigint")) {
                    return DbColumnType.STRING;
                }
                // 将数据库中date类型转成实体String类型
                if (fieldType.toLowerCase().contains("date")) {
                    return DbColumnType.STRING;
                }
                // 将数据库中tinyint类型转成实体Integer类型
                if (fieldType.toLowerCase().contains("tinyint")) {
                    return DbColumnType.INTEGER;
                }
                // 将数据库中decimal类型转成实体BigDecimal类型
